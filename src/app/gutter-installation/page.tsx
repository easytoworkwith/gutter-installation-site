  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-sand via-white to-[#e8efe4]">
        ...
        <div className="container-pad relative grid gap-12 py-16 lg:grid-cols-[1.05fr_.95fr] lg:py-24">
          ...
          <div className="card p-6 lg:p-8">
            <div className="rounded-3xl bg-gradient-to-br from-roof to-ink p-6 text-white">
      ...
      <section id="overview" className="bg-white py-16 lg:py-20">
        <div className="container-pad grid gap-10 lg:grid-cols-[.85fr_1.15fr]">
          <div>
            <span className="badge bg-sand">Original project guide</span>
            <h2 className="mt-4 text-3xl font-extrabold tracking-tight sm:text-4xl">How a gutter project is usually evaluated</h2>
            <p className="mt-5 leading-8 text-ink/70">A gutter project is more than measuring the roof edge. Providers often consider the roof shape, water flow, fascia condition, number of downspouts, ground slope, and where water should be carried after it leaves the roofline.</p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div className="rounded-3xl border border-black/5 bg-sand p-6" key={title}>
      ...
      <section id="types" className="py-16 lg:py-20">
        <div className="container-pad">
          <div className="max-w-3xl">
            <span className="badge">Gutter system options</span>
            <h2 className="mt-4 text-3xl font-extrabold tracking-tight sm:text-4xl">Common gutter types and related components</h2>
            <p className="mt-5 leading-8 text-ink/70">The right system can depend on the home, climate, roofline, and drainage goals. These descriptions are general and do not replace provider recommendations.</p>
          </div>
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            {types.map((type) => (
              <article key={type.title} className="card p-7">
                <div className="flex items-center gap-3">
      ...
      <section id="cost" className="bg-white py-16 lg:py-20">
        <div className="container-pad grid gap-10 lg:grid-cols-2">
          <div>
            <span className="badge bg-sand">No price guarantees</span>
            <h2 className="mt-4 text-3xl font-extrabold tracking-tight sm:text-4xl">What may affect gutter installation cost?</h2>
            <p className="mt-5 leading-8 text-ink/70">This website does not provide fixed prices. Gutter project costs can vary because each property has different measurements, access conditions, materials, and drainage needs.</p>
      ...
      <section className="py-16 lg:py-20">
        <div className="container-pad grid gap-8 lg:grid-cols-3">
          <div className="card p-7">
            ...
            <h3 className="mt-4 text-xl font-bold">Repair Questions</h3>
          ...
          <div className="card p-7">
            ...
            <h3 className="mt-4 text-xl font-bold">Replacement Questions</h3>
          ...
          <div className="card p-7">
            ...
            <h3 className="mt-4 text-xl font-bold">Important Disclosure</h3>
      ...
      <section id="faq" className="bg-white py-16 lg:py-20">
        <div className="container-pad">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-3xl font-extrabold tracking-tight sm:text-4xl">Gutter installation and repair questions</h2>
          </div>
          <div className="mt-10 grid gap-5 md:grid-cols-2">
            {faqs.map((item) => (
              <div className="rounded-3xl border border-black/5 bg-sand p-6" key={item.q}>
      ...
      <section className="bg-ink py-14 text-white">
        <div className="container-pad flex flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-extrabold">Call to check provider availability.</h2>
          ...
          <a className="inline-flex items-center rounded-full bg-white px-6 py-3 text-sm font-bold text-ink" href={siteConfig.phoneHref}><Phone className="mr-2 h-4 w-4" /> {siteConfig.phoneDisplay}</a>
        </div>
      </section>
      <Footer />
    </main>
